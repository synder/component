...
process.on('message', function(message){
    ...
    switch (message.type){
        ...
        case MSG_TYPE.SYS_NODE_APP_PROCESS_INFO: {
            ...
            reporter.report(SYS_NODE_APP_PROCESS.METHOD, SYS_NODE_APP_PROCESS.URL, true, message.data);
        } break;
        ...
        case MSG_TYPE.SYS_NODE_APP_WEBTRANS_INFO: {
            ...
            reporter.report(SYS_NODE_APP_WEBTRANS.METHOD, SYS_NODE_APP_WEBTRANS.URL, true, message.data);
        } break;
